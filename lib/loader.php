...
/* Composer-ready autoloading for future package needs */
...
require 'Exception/SDKIncompleteRequestException.class.php';

require 'Exception/SDKErrorResponseException.class.php';
require 'Exception/SDKUnexpectedResponseException.class.php';
...
require 'Entity/Project/ProjectBugScheme.class.php';
...
require 'Handler/Attachment/AttachmentsHandler.class.php';
